...
export default function Page() {
  return (
    <motion.div animate={{ opacity: 1 }} initial={{ opacity: 0 }}>
      <div className="relative isolate overflow-hidden py-10 px-6 sm:py-12 lg:overflow-visible lg:px-0">
        <div className="mx-auto grid max-w-2xl grid-cols-1 justify-center gap-x-8 gap-y-8 align-middle xl:max-w-[1920px] xl:grid-cols-3 xl:items-start xl:gap-y-10 xl:px-16">
